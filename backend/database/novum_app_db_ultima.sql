...
SELECT pg_catalog.setval('public.candidatos_id_candidato_seq', 8, true);
...
SELECT pg_catalog.setval('public.postulaciones_id_postulacion_seq', 8, true);
...
-- Completed on 2025-07-31 08:51:07
