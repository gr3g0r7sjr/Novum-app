...
export const LoginAdmin = () => {
    ...
    function validate(){
        ...
        if(!formData.password) newErrors.password = "El password es obligatorio"; 
        setErrors(newErrors); 
                ...
                <div className = {styles.formContainer}>
                    ...
                    <form action="" onSubmit = {handleSubmit} className = {styles.form}>
                        ...
                        <div className = {styles.inputContainer}>
                            ...
                            <input type="email" name="email" value = {formData.email} onChange = {handleChange} placeholder = "Tu @email" className = {styles.input} />
                        </div>
                        ...
                        <div className = {styles.inputContainer}>
                            ...
                            <input type="password" name="password" value = {formData.password} onChange = {handleChange} placeholder = "Tu contraseña" className = {styles.input} />
                        </div>
