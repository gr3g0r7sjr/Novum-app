...
const ApplyVacantes = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        const processedFormData = {
            ...
            servicio_interes: formData.servicio_interes ? parseInt(formData.servicio_interes, 10) : null,
        ...
        try {
            ...
            setFormData({
                ...
                habilidades: '', servicio_interes: '', vehiculo: '', fecha_expiracion_datos: '',
            });
    ...
    if (error) return <div className={styles.container}>Error al cargar intereses: {error}</div>;
            ...
            <div className="bg-white p-8 rounded-lg shadow-lg w-full max-w-3xl">
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <fieldset className="border border-gray-300 p-6 rounded-md">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div>
                                ...
                                <input
                                    type="email" id="correo_electronico" name="correo_electronico"
                                    value={formData.correo_electronico} onChange={handleChange} required
                                    className="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm"
                                />
                            </div>
                            <div>
                                ...
                                <input
                                    type="text" id="numero_telefono" name="numero_telefono"
                                    value={formData.numero_telefono} onChange={handleChange}
                                    className="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm"
                                />
                            </div>
                    ...
                    <fieldset className="border border-gray-300 p-6 rounded-md">
                        ...
                        <div>
                            <label htmlFor="educacion" className="block text-sm font-medium text-gray-700">Educación (cada entrada en una nueva línea)</label>
                            <textarea
                                id="educacion" name="educacion" rows="4"
                                value={formData.educacion} onChange={handleChange}
                                className="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm"
                            ></textarea>
                        </div>
                        <div className="mt-4">
                            <label htmlFor="experiencia_laboral" className="block text-sm font-medium text-gray-700">Experiencia Laboral (cada entrada en una nueva línea)</label>
                            <textarea
                                id="experiencia_laboral" name="experiencia_laboral" rows="6"
                                value={formData.experiencia_laboral} onChange={handleChange}
                                className="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm"
                            ></textarea>
                        </div>
                        <div className="mt-4">
                            <label htmlFor="cursos_certificaciones" className="block text-sm font-medium text-gray-700">Cursos y Certificaciones (cada entrada en una nueva línea)</label>
                            <textarea
                                id="cursos_certificaciones" name="cursos_certificaciones" rows="4"
                                value={formData.cursos_certificaciones} onChange={handleChange}
                                className="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm"
                            ></textarea>
                        </div>
                        <div className="mt-4">
                            <label htmlFor="habilidades" className="block text-sm font-medium text-gray-700">Habilidades (cada entrada en una nueva línea)</label>
                            <textarea
                                id="habilidades" name="habilidades" rows="3"
                                value={formData.habilidades} onChange={handleChange}
                                className="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm"
                            ></textarea>
                        </div>
                    </fieldset>
                    ...
                    <fieldset className="border border-gray-300 p-6 rounded-md">
                        ...
                        <div>
                            ...
                            <select
                                ...
                                value={formData.servicio_interes} onChange={handleChange} required
                                className="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm"
                            >
                        ...
                        <div className="mt-4">
                            ...
                            <div className="mt-1 flex items-center space-x-4">
                                <label className="inline-flex items-center">
                                    <input
                                        type="radio" name="vehiculo" value="s¡"
                                        checked={formData.vehiculo === 's¡'} onChange={handleChange}
                                ...
                                <label className="inline-flex items-center">
                                    <input
                                        type="radio" name="vehiculo" value="no"
                                        checked={formData.vehiculo === 'no'} onChange={handleChange}
                                        className="form-radio h-4 w-4 text-blue-600 transition duration-150 ease-in-out"
                                    />
